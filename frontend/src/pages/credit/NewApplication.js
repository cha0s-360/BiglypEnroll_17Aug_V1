    ...
    <CreditLayout title="New Loan Application" subtitle="Capture applicant details for pre-credit assessment">
      ...
      <div className="max-w-3xl bg-white border border-border rounded-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="h-10 w-10 rounded-sm bg-brand-blue flex items-center justify-center"><StepIcon className="h-5 w-5 text-white" /></div>
        ...
        {step === 2 && (
          <div>
            <p className="text-sm text-muted-foreground mb-4">Optional — a co-applicant can improve eligibility. Leave blank to skip.</p>
            <div className="grid md:grid-cols-2 gap-4">
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <label className="flex items-start gap-3 border border-border rounded-sm p-4 cursor-pointer">
